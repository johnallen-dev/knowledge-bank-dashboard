    ...
    <div className="flex items-center justify-center py-24">
      <div className="w-full max-w-sm space-y-4 border rounded-xl bg-card p-6 shadow-sm">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-sm text-muted-foreground">Managing process content is password-protected.</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="space-y-2">
            <Label htmlFor="newspaper-gate-password">Password</Label>
            <Input
              id="newspaper-gate-password"
              type="password"
              value={password}
